...
export const disciplineNotes: DisciplineNote[] = [
  ...
  },
  {
    ...
    "subtopics": [
      ...
      {
        "id": "p_block",
        "title": "p-Block Elements (Groups 15-18)",
        "content": "<h2>1. Group 15 (Nitrogen Family)</h2><p>Nitrogen shows a maximum covalency of 4 and can form $$p\\pi-p\\pi$$ multiple bonds. Phosphorus forms $$P_4$$ molecules. Ammonia ($$NH_3$$) is a Lewis base. The oxides of Nitrogen (e.g., $$N_2O, NO, NO_2$$) vary in oxidation state from +1 to +5.</p><h2>2. Group 16 and 17 (Chalcogens and Halogens)</h2><p>Oxygen shows anomalous behavior due to small size and H-bonding. Ozone ($$O_3$$) is a powerful oxidizing agent. In Group 17, Fluorine is the most electronegative. Chlorine acts as a bleaching agent via oxidation. Interhalogen compounds ($$XY_n$$) are more reactive than the constituent halogens (except $$F_2$$).</p><h2>3. Group 18 (Noble Gases)</h2><p>Noble gases have closed-shell configurations. <b>Neil Bartlett</b> synthesized the first compound, $$XePtF_6$$. Xenon fluorides ($$XeF_2, XeF_4, XeF_6$$) have distinct geometries (Linear, Square Planar, Distorted Octahedral) explained by VSEPR. $$XeF_6$$ undergoes partial hydrolysis to form $$XeOF_4$$ and complete hydrolysis to $$XeO_3$$.</p>"
      }
    ]
  }
];
